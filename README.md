...
-A Rational Database is a way to store data. SQL is the language that is used to speak with the data.

2. Why do tables need a `primary key`?

-A primary key is a unique identifier that can be used as a reference when calling or modifying the data.
...
-A third table is required which then references both tables to allow multiple relationships.
